...
export const waitForMesage = ({ message, user, time = 120000, whoCanReply = 'useronly' }: { message: Message; user: User; time?: number; whoCanReply?: 'useronly' | 'everyoneexeptuser' | 'everyone'}) => {
